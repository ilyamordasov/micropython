...
class ST7735(object) :
  ...
  def __init__( self, cs = 18, sck = 5, mosi = 13, miso = 2, aDC = 16, aReset = 17) :
    ...
    self.cs(1)
    self.spi = SPI(2, baudrate = 20000000, polarity = 0, phase = 0, sck = Pin(sck), mosi = Pin(mosi), miso = Pin(miso))
